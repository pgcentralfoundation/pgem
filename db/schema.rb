...
ActiveRecord::Schema.define(version: 2026_05_04_130768) do
  ...
  create_table "r", id: false, force: :cascade do |t|
    t.integer "sponsor_id"
    t.integer "id"
    t.string "email"
  ...
  create_table "test_users_trim", id: false, force: :cascade do |t|
    t.integer "id"
    t.string "email"
    t.string "encrypted_password"
    t.string "reset_password_token"
