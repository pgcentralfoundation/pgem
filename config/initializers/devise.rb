...
Devise.setup do |config|
  ...
  config.omniauth :google_oauth2, (ENV['OSEM_GOOGLE_KEY'] || Rails.application.credentials.google_key), (ENV['OSEM_GOOGLE_SECRET'] || Rails.application.credentials.google_secret),
                  name: 'google',
                  scope: 'email'
  config.omniauth :facebook, (ENV['OSEM_FACEBOOK_KEY'] || Rails.application.credentials.facebook_key), (ENV['OSEM_FACEBOOK_SECRET'] || Rails.application.credentials.facebook_secret)
  config.omniauth :github, (ENV['OSEM_GITHUB_KEY'] || Rails.application.credentials.github_key), (ENV['OSEM_GITHUB_SECRET'] || Rails.application.credentials.github_secret)
